class dotnetexample (
  $websitename        = 'DotNetExample',
  $zipname            = '16781.zip',
  $sourcerepo         = 'http://buildtool.mcafee.com/PackageDownload/QA/',
  $destinationpath    = 'D:\inetpub\platformutil.mcafee.com-distribution\Utilities',
